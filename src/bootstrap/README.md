...
[![Downloads](https://img.shields.io/npm/dm/svogv.svg?style=flat-square)](https://npmjs.com/packages/@svogv/bootstrap)
[![Version](https://img.shields.io/npm/v/svogv.svg?style=flat-square)](https://npmjs.com/packages/@svogv/bootstrap)
[![License](https://img.shields.io/npm/l/svogv.svg?style=flat-square)](https://npmjs.com/packages/@svogv/bootstrap)
...
> This is the lib with a set of components built on top of the Bootstrap 4 project. See @svogv/material for an identical solution for Angular Material 2. There is no share between both to keep the libs' footprint small. You use one or the other.
