...
export class AcEditor implements OnInit {
  ...
  // Error matcher for material's <mat-error> directive
  private matcher = new AcErrorStateMatcher();
  ...
  /**
   * The minimum number of lines for a textarea. Applies to textarea only.
   */
  @Input() autoResizeMin = 2;

  /**
   * The maximum number of lines for a textarea. Applies to textarea only.
   */
  @Input() autoResizeMax = 5;
