...
[![Downloads](https://img.shields.io/npm/dm/svogv.svg?style=flat-square)](https://npmjs.com/packages/@svogv/material)
[![Version](https://img.shields.io/npm/v/svogv.svg?style=flat-square)](https://npmjs.com/packages/@svogv/material)
[![License](https://img.shields.io/npm/l/svogv.svg?style=flat-square)](https://npmjs.com/packages/@svogv/material)
...
> This is the lib with a set of components built on top of the Angular Material 2 project. See @svogv/bootstrap for an identical solution for Bootstrap 4. There is no share between both to keep the libs' footprint small. You use one or the other.
...
~~~
import * as Validator from '@svogv/material';
...
~~~
import { FormValidatorService } from '@svogv/material';
