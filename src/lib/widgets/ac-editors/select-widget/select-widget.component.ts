...
import { SRFormPubSubService } from '../../../shared/services/srf-pubsub.service';
...
export class SelectWidgetComponent implements OnInit, Widget {
	 ...
	 */
	constructor(private el: ElementRef, private srfPubSub: SRFormPubSubService) {
	}
	 ...
	 * @return number|null
	 */
	private getIndexByVal(value: string, arr: Array<string>) {
		let index = null;
	 ...
	 */
	openList() {
		this.srfPubSub.trigger('select:close:all');
