...
<a name="0.3.0"></a>
# [0.3.0](https://github.com/joergkrause/svogv/releases/tag/0.3.0)

Split into @svogv area.

<a name="0.3.7"></a>
# [0.3.7](https://github.com/joergkrause/svogv/releases/tag/0.3.7)

Finished split into @svogv area.

<a name="0.4.0"></a>
# [0.4.0](https://github.com/joergkrause/svogv/releases/tag/0.4.0)

Added Flex-Layout to comply the Bootstrap Grid in Material design.
